 ...
 * This will be replaced with the actual Auto Pilot component
 * after Dev 4 completes the content strategy view migration.
 * 
 * Old route: /content-strategy?view=auto-pilot
 * New route: /content/auto-pilot
 */
export default function ContentAutoPilotPage() {
  ...
  useEffect(() => {
    ...
    router.replace("/content-strategy?view=auto-pilot");
  }, [router]);
